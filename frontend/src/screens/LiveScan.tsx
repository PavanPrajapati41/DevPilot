...
export default function LiveScan({
  ...
  useEffect(() => {
    ...
    const total = SCAN_STAGES.reduce(
      (s, st) => s + st.duration,
      0
    );
  ...
  useEffect(() => {
    if (!animationDone || !auditReady) return;
  ...
  }, [animationDone, auditReady, onComplete]);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(91,127,255,0.4), transparent)",
          animation:
            "scan-sweep 3.5s ease-in-out infinite",
          top: 0,
        }}
      />
      ...
      <div className="w-full max-w-2xl px-6">
        ...
        >
          <div
            className="inline-flex items-center gap-2.5 mb-4 px-3.5 py-1.5 rounded-full glass"
            style={{
              border:
                "1px solid rgba(91,127,255,0.18)",
            }}
          >
            <motion.div
          ...
          <h2
            className="t-headline mb-1 font-mono"
            style={{
              fontFamily:
          ...
          >
            <motion.div
              ...
              style={{
                width: `${progress}%`,
                background:
                  "linear-gradient(90deg, var(--accent), #7c6eff)",
              }}
              transition={{
                duration: 0.1,
              }}
